    ...
    <section class="section">
      <div class="row d-flec justify-content-center">
		...
		@endif 
              ...
              <form method="POST" enctype="multipart/form-data" action="{{url('aboutupdate')}}/{{$data->id}}">
                @csrf  
                <div class="row mb-3 p-3"> 
                  <div class="col-sm-12">
                    <textarea name="content" class="form-control" id="summernote" >{{$data->content}}</textarea>
